...
<cfif isDefined("form.saveButton")>
	...
	<cfif isDefined("form.emailAddress") && !errorBean.hasErrors()>
	...
	<cfif isDefined("form.firstName") && !errorBean.hasErrors()>
	...
	<cfif isDefined("form.lastName") && !errorBean.hasErrors()>
	...
	<cfif isDefined("form.studentId") && !errorBean.hasErrors()>
	...
	<cfif isDefined("form.password") && !errorBean.hasErrors()>
		<cfif len(form.password)>
			<cfif !len(trim(form.password))>
				<cfset errorBean.addError('The new password cannot be blank.', 'password')>
			<cfelse>
	...
	<!--- Close form if there were no errors --->
